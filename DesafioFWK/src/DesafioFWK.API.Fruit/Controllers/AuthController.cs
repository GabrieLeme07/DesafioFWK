using DesafioFWK.API.Fruit.Extensions;
using DesafioFWK_Application.Interfaces;
using DesafioFWK_Application.ViewModel.User;
...
namespace DesafioFWK.API.Fruit.Controllers
{
    public class AuthController : MainController
    {
        ...
        public async Task<IActionResult> Login([FromBody]LoginUserViewModel loginUser)
        {
            ...
            {
                var validationFailureLocked = new ValidationFailure
                    ("User Locked", "Usuário temporariamente bloqueado por tentativas inválidas");
                validation.Errors.Add(validationFailureLocked);
                return CustomResponse(validation);
            }

            var validationFailure = new ValidationFailure
                    ("User Password", "Usuário ou Senha incorretos");
